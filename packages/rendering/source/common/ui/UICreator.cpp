...
namespace l::ui {
    ...
    UIHandle CreateUINode(UIStorage& uiStorage, l::nodegraph::NodeGraphBase& node, ImVec2 p) {
        ...
        ImVec2 sizeEstimate = ImVec2(100.0f, 22.0f + 19.0f * (numInputChannels > numOutputChannels ? numInputChannels : numOutputChannels));
        {
            float ioSize = 4.0f;
            ...
            for (int8_t i = 0; i < numInputChannels || i < numOutputChannels; i++) {
                ...
                node4->Add(row);
                {
                    ...
                    if (i < numOutputChannels - numConstants) {
                        ...
                        auto inText = CreateContainer(uiStorage, l::ui::UIContainer_EditFlag | l::ui::UIContainer_DrawFlag, l::ui::UIRenderType::NodeOutputValue, l::ui::UIAlignH::Left);
                        inText->SetPosition(ImVec2(0.0f, 0.0f));
